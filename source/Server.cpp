...
//
//    session->on_close( );
//    service->close_session_callback_( session );
//    service->remove_session( session );
//    SAFE_DELETE( session );
//
//    if ( service->service_type_ == Service::ServiceType::kClient )
//    {
//        SAFE_DELETE( service );
//    }
//}
...
//        uv_close( ( uv_handle_t* ) &srv->uv_tcp_ , Server::uv_callback_close );
//    }
//    else if ( srv->service_type_ == Service::ServiceType::kServer )
//    {
//
//    }
//
